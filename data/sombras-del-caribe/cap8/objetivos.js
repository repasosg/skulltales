...
<div class="objetivos-container">
    ...
    <select class="selector-pirata" onchange="window.mostrarRecompensaObjetivo(this)">
        ...
        <option value="obj4" data-recompensa="5 <img src='variosimg/prestigio.png' class='icono-personaje2'> y 40 <img src='variosimg/oro.png' class='icono-personaje2'> (Objeto)">
            Objetivo 4
        </option>
