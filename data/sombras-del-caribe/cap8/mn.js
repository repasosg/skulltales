...
<table style="width: 100%; border-collapse: collapse; margin-top: 10px;">
  ...
  <tbody>
    <tr>
       <td style="border: 1px solid #b89b65; padding: 8px;">Al Buscar con éxito en la loseta i8</td>
       <td style="border: 1px solid #b89b65; padding: 8px;"><button onclick="cargarTexto('MN73')">073</button></td>
       <td style="border: 1px solid #b89b65; padding: 8px;">-</td>
    </tr>
    <tr>
       <td style="border: 1px solid #b89b65; padding: 8px;">Al Buscar con Exito en una loseta de Cueva</td>
       <td style="border: 1px solid #b89b65; padding: 8px;"><button onclick="cargarTexto('MN63')">063</button></td>
       <td style="border: 1px solid #b89b65; padding: 8px;">-</td>
    </tr>
    <tr>
    ...
    <tr>
       ...
       <td style="border: 1px solid #b89b65; padding: 8px;"><button onclick="cargarTexto('MN98')">098</button></td>
       <td style="border: 1px solid #b89b65; padding: 8px;">-</td>
    </tr>
    <tr>
       <td style="border: 1px solid #b89b65; padding: 8px;" colspan="3">
         <button onclick="cargarTexto('MN15')">015</button>
         <button onclick="cargarTexto('MN38')">038</button>
         <button onclick="cargarTexto('MN41')">041</button>
         <button onclick="cargarTexto('MN64')">064</button>
         <button onclick="cargarTexto('MN94')">094</button>
         <button onclick="cargarTexto('MN97')">097</button>
         <button onclick="cargarTexto('MN103')">103</button>
         <button onclick="cargarTexto('MN120')">120</button>
         <button onclick="cargarTexto('MN141')">141</button>
       </td>
    </tr>
  </tbody>
</table>
