...
<table style="width: 100%; border-collapse: collapse; margin-top: 10px;">
  ...
  <tbody>
    ...
    <tr>
       ...
       <td style="border: 1px solid #b89b65; padding: 8px;"><button onclick="cargarTexto('MN26')">026</button></td>
    ...
    <tr>
       ...
       <td style="border: 1px solid #b89b65; padding: 8px;"><button onclick="cargarTexto('MN74')">074</button></td>
       <td style="border: 1px solid #b89b65; padding: 8px;">-</td>
    </tr>
    <tr>
       <td style="border: 1px solid #b89b65; padding: 8px;">Si un Personaje es afectado por el Espíritu de Oggun</td>
       <td style="border: 1px solid #b89b65; padding: 8px;"><button onclick="cargarTexto('MN108')">108</button></td>
       <td style="border: 1px solid #b89b65; padding: 8px;">-</td>
    </tr>
    <tr>
       <td style="border: 1px solid #b89b65; padding: 8px;">Si los Personajes logran superar la aventura</td>
       <td style="border: 1px solid #b89b65; padding: 8px;"><button onclick="cargarTexto('MN111')">111</button></td>
       <td style="border: 1px solid #b89b65; padding: 8px;">-</td>
    </tr>
    <tr>
       <td style="border: 1px solid #b89b65; padding: 8px;" colspan="3">
         <button onclick="cargarTexto('MN2')">002</button>
         <button onclick="cargarTexto('MN11')">011</button>
         <button onclick="cargarTexto('MN68')">068</button>
         <button onclick="cargarTexto('MN79')">079</button>
         <button onclick="cargarTexto('MN106')">106</button>
         <button onclick="cargarTexto('MN109')">109</button>
         <button onclick="cargarTexto('MN115')">115</button>
       </td>
    </tr>
  </tbody>
</table>
