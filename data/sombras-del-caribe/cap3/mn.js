...
<table style="width: 100%; border-collapse: collapse; margin-top: 10px;">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="border: 1px solid #b89b65;">
                <button onclick="mostrarPopupImagen('losetas/Cap 3 - loseta i10.png')">I10</button>
            </td>
        </tr>
        <tr>
            ...
            <td style="border: 1px solid #b89b65;">
                <button onclick="mostrarPopupImagen('losetas/Cap 3 - loseta i16.png')">I16</button>
            </td>
        </tr>
        <tr>
            ...
            <td style="border: 1px solid #b89b65;">
                <button onclick="mostrarPopupImagen('losetas/Cap 3 - loseta c1.png')">C1</button>
            </td>
        </tr>
        <tr>
            ...
            <td style="border: 1px solid #b89b65;">
                <button onclick="mostrarPopupImagen('losetas/Cap 3 - loseta c2.png')">C2</button>
            </td>
        </tr>
        <tr>
