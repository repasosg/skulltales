...
<table style="width: 100%; border-collapse: collapse;">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="border: 1px solid #b89b65; padding: 10px; text-align: center;"><button class="ojo-button" onclick="ChapterLoader.mostrarMN('MN1505')">1505</button></td>
    ...
    <tr>
      ...
      <td style="border: 1px solid #b89b65; padding: 10px; text-align: center;"><button class="ojo-button" onclick="ChapterLoader.mostrarMN('MN2278')">2278</button></td>
      <td style="border: 1px solid #b89b65; padding: 10px; text-align: center;">-</td>
    </tr>
    <tr>
      <td style="border: 1px solid #b89b65; padding: 10px;">Si los personajes logran continuar a la siguiente aventura</td>
      <td style="border: 1px solid #b89b65; padding: 10px; text-align: center;"><button class="ojo-button" onclick="ChapterLoader.mostrarMN('MN1206')">1206</button></td>
      <td style="border: 1px solid #b89b65; padding: 10px; text-align: center;">-</td>
    </tr>
  </tbody>
</table>
