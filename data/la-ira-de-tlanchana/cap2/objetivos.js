...
<div class="objetivos-container">
    ...
    <select class="selector-pirata" onchange="window.mostrarRecompensaObjetivo(this)">
        ...
        <option value="obj1" data-recompensa="10 <img src='variosimg/prestigio.png' class='icono-personaje2'> + 30 <img src='variosimg/oro.png' class='icono-personaje2'> (Objeto)">
            Objetivo 1
        </option>
        
        <option value="obj2" data-recompensa="10 <img src='variosimg/prestigio.png' class='icono-personaje2'> (Objeto (PNJ secuestrado))">
            Objetivo 2
        </option>
    </select>
