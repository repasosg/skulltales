...
<table style="width: 100%; border-collapse: collapse;">
  <thead>
    <tr>
      <th style="border: 1px solid #b89b65; padding: 10px;">Desencadenante</th>
      <th style="border: 1px solid #b89b65; padding: 10px;">MN</th>
      <th style="border: 1px solid #b89b65; padding: 10px;">Loseta</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td style="border: 1px solid #b89b65; padding: 10px;">Al Explorar la primera loseta</td>
      <td style="border: 1px solid #b89b65; padding: 10px; text-align: center;"><button class="ojo-button" onclick="ChapterLoader.mostrarMN('MN1997')">1997</button></td>
      <td style="border: 1px solid #b89b65; padding: 10px; text-align: center;">-</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="border: 1px solid #b89b65; padding: 10px; text-align: center;"><button class="ojo-button" onclick="ChapterLoader.mostrarMN('MN1866')">1866</button></td>
      <td style="border: 1px solid #b89b65; padding: 10px; text-align: center;">-</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="border: 1px solid #b89b65; padding: 10px; text-align: center;"><button class="ojo-button" onclick="ChapterLoader.mostrarMN('MN1507')">1507</button></td>
      <td style="border: 1px solid #b89b65; padding: 10px; text-align: center;">-</td>
    </tr>
  </tbody>
</table>
